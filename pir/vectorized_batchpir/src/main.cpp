...
int batchpir_main(int argc, char* argv[])
{
    ...
    // input_choices.push_back({50, 1048576/2, 612});
    input_choices.push_back({std::stoul(argv[1]), std::stoul(argv[2]), std::stoul(argv[3])});
 ...
 for (size_t iteration = 0; iteration < input_choices.size(); ++iteration)
{
    ...
    {
        // cout << "PIR Input Parameters: ";
        // cout << "Batch Size: " << input_choices[i][0] << ", ";
        // cout << "Number of Entries: " << input_choices[i][1] << ", ";
        // cout << "Entry Size: " << input_choices[i][2] << endl;

        cout << "PIR Initialization time: " << init_times[i].count() << " milliseconds" << endl;
        cout << "PIR Query generation time: " << query_gen_times[i].count() << " milliseconds" << endl;
        cout << "PIR Response generation time: " << resp_gen_times[i].count() << " milliseconds" << endl;
        cout << "PIR Total communication: " << communication_list[i] << " KB" << endl;
        cout << endl;
    }
